...
import HighwayLayer from './HighwayLayer.js';
import MarkerClusterGroup from 'react-leaflet-cluster';
import { booleanPointInPolygon } from '@turf/turf';
import axios from 'axios';
import LinkFetcher from './linkFetcher.js';
import { ZoomSlider, CountrySearchBar, OpenStationSwitch } from './AntComponents.js';
...
const Map = () => {
  ...
  const handleLinkIdsFetched = (fetchedLinkIds) => {
      ...
      <MapContainer center={mapCenter} key={zoom} zoom={zoom} minZoom={2} style={{ height: '95vh', width: '100%', margin: 'auto', verticalAlign: 'center' }}>
        ...
        {isLoading ? (
          ...
          <>
            ...
            {linkIds.length > 0 && <HighwayLayer linkIds={linkIds} />}
            {selectedCountry && (
